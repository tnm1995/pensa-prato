...
import { Clock, Users, Flame, ArrowLeft, ShoppingBasket, ChevronRight, Heart, CheckCircle2, Wind, ChefHat, UtensilsCrossed } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gray-50 pb-8">
      <div className="bg-white shadow-sm sticky top-0 z-10">
        <div className="flex items-center p-4">
          ...
          <div>
            <h1 className="text-xl font-bold text-gray-800">Sugestões do Chef</h1>
            <p className="text-xs text-gray-500">Baseado na sua imagem</p>
          </div>
        </div>
      </div>
        ...
        {recipes.map((recipe, idx) => {
          ...
          return (
            <div 
              ...
              className="bg-white rounded-2xl shadow-sm border border-gray-100 p-5 hover:shadow-md transition-all active:scale-[0.99] cursor-pointer relative group"
            >
              <div className="flex justify-between items-start mb-3">
                  ...
                  <button 
                    ...
                    className="p-2 -mt-2 -mr-2 rounded-full hover:bg-red-50 transition-colors z-10 relative"
                  >
                    <Heart 
              ...
              <div className="flex flex-wrap items-center gap-2 mb-4">
                  ...
                  <div className="flex items-center gap-1.5 text-xs font-medium text-gray-600 bg-gray-50 px-2.5 py-1 rounded-lg border border-gray-100 ml-auto">
